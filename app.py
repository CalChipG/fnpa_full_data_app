...
##Not sure if following login info is necessary
...
def chart1(df_filtered):
    ...
    if agree:
        ...
        # df_tmp = df_filtered.groupby('Facility Name', as_index=False)[co2_column].sum()
        # df_tmp = df_tmp.sort_values(co2_column, ascending=False)
        # top_15 = df_tmp[reporting_axis].head(15).unique()
        # df_filtered = df_filtered.loc[df_filtered['Facility Name'].isin(top_15)]
